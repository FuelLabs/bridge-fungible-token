...
// TO DO: use helper functions from std::tx when ready
...
/// Length is implicitly provided by casting to an array of u64. The bytecode is thus right-padded to the next full word
...
fn main() -> bool {
    ...
    let message_data_contract_id = verify_and_get_message_input_data_contract_id(1);
    let input_contract_id = verify_and_get_contract_input_contract_id(2);
